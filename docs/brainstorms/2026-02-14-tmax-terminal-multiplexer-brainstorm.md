...
### Web Bridge (tmax-web)
- Separate Rust service connecting to tmax-local via Unix socket
...
tmax/
  ...
  crates/
    ...
    tmax-local/          # server binary - manages sessions, listens on socket
...
- `tmax-local`: daemon managing sessions, Unix socket listener
